        ...
        <div key={u.id}>
            <span>
                ...
                <div>
                    {
                        u.followed ? 
                        <button onClick={() => props.onUnFollow(u.id)} disabled={props.followingInProgress.some(id => id === u.id)}>Unfollow</button>                     
                        :
                        <button onClick={() => props.onFollow(u.id)} disabled={props.followingInProgress.some(id => id === u.id)}>Follow</button>                     
                    }
